<title>PROCESO DEL REPORTE DE VENTAS
</title>
      ...
      <table class="table table-border">
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              <td class=""><?php echo remove_junk($result['ventas_fecha']);?></td>
              <td class="desc">
                <h6><?php echo remove_junk(ucfirst($result['medicamentos_nombre']));?></h6>
              </td>
              <td class="text-right"><?php echo remove_junk($result['medicamentos_precioc']);?></td>
              <td class="text-right"><?php echo remove_junk($result['medicamentos_preciov']);?></td>
